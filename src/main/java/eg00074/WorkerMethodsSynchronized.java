 ...
 * may execute the stageOne while other executes stageTwo. <br>
 * <br>
...
public class WorkerMethodsSynchronized {
	 ...
	 * methods if one thread runs the stageOne other thread cannot run stageTwo at
	 * the same time because that same locks are used. Solution is using two lock
	 * Object for two shared data.
	 */
