...
public class IntersectionOfTwoLinkedListUsingHashingTester {
	...
	public static void main(String[] args) {
		...
		Node intersectionOfTwoLinkedListUsingHashing = list.getIntersectionOfTwoLinkedListUsingHashing(head1, head2);

		System.out.println("\n\nIntersection of 2 LinkedLists Using Hashing : ");
		list.printLinkedList(intersectionOfTwoLinkedListUsingHashing);
