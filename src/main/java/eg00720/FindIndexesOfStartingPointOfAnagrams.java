...
public class FindIndexesOfStartingPointOfAnagrams {

	public List<Integer> getAllAnagrams(String str, String pattern) {
	...
	public static void main(String[] args) {
		...
		FindIndexesOfStartingPointOfAnagrams obj = new FindIndexesOfStartingPointOfAnagrams();
		String str = "bcdcbabcbd";
		String pattern = "abc";
		List<Integer> allAnagrams = obj.getAllAnagrams(str, pattern);
