...
public class AreTwoStringsAnagramOrPermutationOfOneAnotherDemo {

	public static void main(String[] args) {

		AreTwoStringsAnagramOrPermutationOfOneAnotherDemo obj = new AreTwoStringsAnagramOrPermutationOfOneAnotherDemo();
