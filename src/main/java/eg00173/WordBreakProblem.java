...
public class WordBreakProblem {
	...
	public static void main(String[] args) {
		...
		System.out.println(wordBreak("mobilesamsung"));
		System.out.println(wordBreak("samman"));
		System.out.println(wordBreak("samicelike"));
		System.out.println(wordBreak("samsungandmangocream"));
