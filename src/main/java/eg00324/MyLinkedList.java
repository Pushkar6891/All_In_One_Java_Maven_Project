...
// 2. If we do not want duplicates in Sorted Linked List add another else if check
			if (a.data < b.data) {
				// commented line 1: tempNode.next = a;
				// tempNode.next = a;
				a = a.next;
			} else if (a.data > b.data) {
				// commented line 2: tempNode.next = b;
				// tempNode.next = b;
				b = b.next;
			} else if (a.data == b.data) {
				tempNode.next = a;
				// added line 3: tempNode = tempNode.next;
				tempNode = tempNode.next;
				a = a.next;
				b = b.next;
			}
			// commented line 4: tempNode = tempNode.next;
			// tempNode = tempNode.next;
		}
		// commented line 5 : tempNode.next = (a == null) ? b : a;
		tempNode.next = null;
		return finalList.next;
	}
}
